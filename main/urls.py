...
urlpatterns = [
    ...
    path("pages/food/show", views.foodProductShow, name="main_food_show"),
    ...
    path("v2/", views.adminProfile, name="admin_profile"),
    path("v2/profile/edit", views.adminEditProfile,
         name="admin_profile_edit"),
    path("v2/profile/change-picture", views.adminChangePicture,
         name="admin_change_picture"),

    # Customer
    path("v2/", views.customerIndex, name="customer_index"),
    path("v2/profile/edit", views.customerEditProfile,
         name="customer_profile_edit"),
    path("v2/profile/change-picture", views.customerChangePicture,
