...
urlpatterns = [
    ...
    path("pages/viewproduct/category/<int:id>", views.ViewProductByCategory, name='view_product_category'),
    ...
    path("v1/order/canceling/<int:id>", views.adminCancellingOrder, name="admin_toCancel_order"),
    ...
    path("v2/order/cancel/<int:id>", views.customerCancelOrder, name='customer_cancel_order'),
